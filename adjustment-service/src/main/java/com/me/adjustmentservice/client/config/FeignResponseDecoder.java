package com.me.adjustmentservice.client.config;

import com.fasterxml.jackson.databind.JavaType;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.me.adjustmentservice.exception.AdjustmentServiceException;
import com.me.adjustmentservice.exception.ApiResponse;
    ...
    public Object decode(Response response, Type type) throws IOException {
        ...
        try (InputStream is = response.body().asInputStream()) {
            ...
            if ("fail".equals(apiResponse.getStatus())) {
                throw new AdjustmentServiceException(ErrorCode.EXTERNAL_API_ERROR);
            }
